...
import 'package:e_doc_redo/ui/features/document/views/widgets/forms/send_document_dialog.dart';
...
import 'package:e_doc_redo/ui/features/document/views/detail_document_screen.dart';
import 'package:e_doc_redo/ui/features/document/views/detail_incoming_document_screen.dart';
import 'package:e_doc_redo/ui/features/document/views/widgets/forms/document_create_form.dart';
                ...
                ListView.separated(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    final card = ListCardDocument(
                      ...
                      // Only outgoing: tap badge → open status picker
                      onStatusChanged:
                          isOutgoing ? (_) => _showStatusPicker(doc) : null,
                      // Non-outgoing types: show the more_vert menu icon
                    ...
                    if (isOutgoing) {
                      return GestureDetector(
                        onTap: () {
                          ...
                          final controller =
                              Get.put(DocumentDetailController());
                    ...
                    if (isIncoming) {
                      return GestureDetector(
                        onTap: () {
                          ...
                          controller.loadDocument(doc.id.toString());
                          Get.to(
                              () => const DetailIncomingDocumentScreen());
                        },
                        child: card,
                      );
                    }
